...
if __name__ == "__main__":
    ...
    parser.add_argument("--sim_config", type=str, default="configs/filesystem/sim_config.json", help="Path to JSON configuration file")
    parser.add_argument("--train_ai_config", type=str, default="configs/filesystem/train_ai_config.json", help="Path to JSON configuration file")
    parser.add_argument("--infer_ai_config", type=str, default="configs/filesystem/infer_ai_config.json", help="Path to JSON configuration file")
